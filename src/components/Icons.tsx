...
export function GlassIcon({ className, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      ...
      {...props}
    >
      <path d="M8 2h8l-1 9a4 4 0 0 1-6 0L8 2z" />
      <path d="M12 11v9" />
      <path d="M8 22h8" />
    </svg>
  );
...
export function UtensilsIcon({ className, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function SendPhoneIcon({ className, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
